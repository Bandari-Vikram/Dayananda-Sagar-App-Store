...
function FlipCard({ app, target }: FlipCardProps) {
  return (
    <motion.a
      href={app.url}
      target="_blank"
      ...
      className="group z-20 cursor-pointer pointer-events-auto"
    ...
    >
      ...
      >
        <div
          className="absolute inset-0 flex h-full w-full flex-col items-center justify-center overflow-hidden rounded-full shadow-lg ring-2 ring-white/30"
        ...
        <div className="perspective-1000 flex h-full w-full flex-col items-center justify-center">
          ...
          <div className="relative flex h-full w-full items-center justify-center">
            {APP_CARDS.slice(0, TOTAL_IMAGES).map((app, i) => {
              ...
              return (
                <FlipCard key={app.name} app={app} index={i} total={TOTAL_IMAGES} phase={introPhase} target={target} />
              );
            })}
          </div>
        </div>
